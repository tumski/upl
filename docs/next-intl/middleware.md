[Docs](/docs/getting-started "Docs")[Routing](/docs/routing "Routing")Middleware
...
[](#accept-language-matching)Which algorithm is used to match the accept-language header against the available locales?
