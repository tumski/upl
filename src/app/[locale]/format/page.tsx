...
export default function FormatPage() {
  ...
  const [paperType, setPaperType] = useState<PaperType>('matte');
  ...
  useEffect(() => {
    ...
    if (savedFormat.size) {
      setSelectedSize(savedFormat.size as PrintSize);
    }
    if (savedFormat.paperType) {
      setPaperType(savedFormat.paperType as PaperType);
    }
    if (savedFormat.frameColor) {
      setFrameColor(savedFormat.frameColor as FrameColor);
    }
  }, [router, params]);
