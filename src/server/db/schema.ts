...
export const items = pgTable("items", {
  ...
  topazProcessId: text("topaz_process_id"),
  enhancedImageUrl: text("enhanced_image_url"),
  upscalingAttempts: integer("upscaling_attempts").default(0).notNull(),
  lastUpscalingAttempt: timestamp("last_upscaling_attempt"),
